            ...
            ?.mapNotNull { variant ->
              variant.attributes?.let { attrs ->
                when (attrs.orgJetbrainsKotlinPlatformType) {
                  ...
                  "native" ->
                      when (attrs.orgJetbrainsKotlinNativeTarget) {
                        ...
                        "watchos_simulator_arm64" ->
                            KotlinTarget.Native.WatchOS.WatchOSSimulatorArm64
                    ...
                    ?: (attrs.orgJetbrainsKotlinNativeTarget
                            ?: attrs.orgJetbrainsKotlinPlatformType)?.let(KotlinTarget::Unknown)
              }
            }
            ?.toSet()
}
